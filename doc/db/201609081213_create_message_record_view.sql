...
/****** Object:  View [dbo].[MessageRecordView]    Script Date: 09/08/2016 12:13:22 ******/
SET ANSI_NULLS ON
GO
...
SELECT     dbo.MessageRecord.id, dbo.MessageRecord.staffNr, dbo.MessageRecord.operatorId, dbo.MessageRecord.messageType, dbo.MessageRecord.createdAt, 
                      dbo.MessageRecord.text, dbo.MessageRecord.isRead, dbo.MessageRecord.isHandled, dbo.MessageRecord.isUrl, dbo.MessageRecord.url, 
                      dbo.MessageRecord.uniqString, dbo.[User].name AS operatorName, dbo.[User].email AS operatorEmail, dbo.Staff.name AS staffName
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[49] 4[30] 2[17] 3) )"
      End
